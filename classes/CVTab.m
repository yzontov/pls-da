        ...
        function Redraw(self)
            ...
            if self.ddlResultViewMode.Value == 1 %graph view
                ...
                if mode == 1 % summary
                    ...
                    rec.model.PlotNewSet(self.cv_plot_axes, 1, 2, true);
                ...
                if mode == 1%summary
                    ...
                    if isfield(self.cvtask.Results,'alpha')
                        als = unique([self.cvtask.Results.alpha]);
                        self.cvtask.GetSummary(pcs(pc),als(alpha));
                    else
...
%                 
                 ...
                 self.ddlResultCategory.Value = 2;%
                 self.ddlSelectedSplit.Visible = 'on';%
%                 self.lblSelectedPC.Visible = 'on';%
